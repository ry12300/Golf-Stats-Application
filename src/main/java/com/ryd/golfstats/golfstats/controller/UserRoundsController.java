...
public class UserRoundsController {
    ...
    @ResponseStatus(HttpStatus.OK)
    public void patch(@PathVariable String userId, @PathVariable String roundId, @Valid @RequestBody Round updatedRound) {
        //todo - need to return an id?

        ObjectId objectId = new ObjectId(roundId);

        userRoundService.patch(userId, objectId, updatedRound);
